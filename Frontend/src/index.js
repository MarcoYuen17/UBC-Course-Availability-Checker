        ...
        return (
            <form onSubmit={this.handleSubmit} id='main'>
                <div className='formGrid'>
                    ...
                    <label htmlFor='phoneNum' id='phoneNumLabel'>Your Phone Number:</label>
                    ...
                    <label htmlFor='id' id='idLabel'>Course ID:</label>
                    <input type='text' name='desiredCourseId' id='id' value={this.state.desiredCourseId} onChange={this.handleChange} required/>
                    <label htmlFor='section' id='sectionLabel'>Section:</label>
                    <input type='text' name='desiredCourseSection' id='section' value={this.state.desiredCourseSection} onChange={this.handleChange} required/>
                    <label htmlFor='seatType' id='seatTypeLabel'>Seat Type:</label>
                    <input list='seatType' name='desiredSeatType' id='seatTypeInput' value={this.state.desiredSeatType} onChange={this.handleChange} required/>
